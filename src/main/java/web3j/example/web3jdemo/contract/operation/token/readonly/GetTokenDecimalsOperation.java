...
import static web3j.example.web3jdemo.contract.operation.actiontype.TokenContractActionType.GET_DECIMALS;

@Component
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class GetTokenDecimalsOperation extends AbstractTokenContractReadonlyOperation {

    private static final TokenContractActionType ACTION_TYPE = GET_DECIMALS;
