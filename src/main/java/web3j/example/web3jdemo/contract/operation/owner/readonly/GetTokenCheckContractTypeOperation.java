...
import static web3j.example.web3jdemo.contract.operation.actiontype.ContractOwnerActionType.GET_CHECK_CONTRACT_TYPE;

@Component
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class GetTokenCheckContractTypeOperation extends AbstractTokenContractReadonlyOperation {

    private static final ContractOwnerActionType ACTION_TYPE = GET_CHECK_CONTRACT_TYPE;
