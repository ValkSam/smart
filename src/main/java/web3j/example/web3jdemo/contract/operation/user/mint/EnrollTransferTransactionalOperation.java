...
public class EnrollTransferTransactionalOperation extends AbstractContractUserMintTransactionalOperation {

    private static final ContractUserActionType ACTION_TYPE = ENROLL;

    public EnrollTransferTransactionalOperation(DldWallet dldWallet,
                                                BigInteger amount,
                                                String documentUid,
                                                String data) {
