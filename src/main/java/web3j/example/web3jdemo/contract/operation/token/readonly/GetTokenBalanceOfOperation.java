...
import static web3j.example.web3jdemo.contract.operation.actiontype.TokenContractActionType.GET_BALANCE_OF;

@Component
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class GetTokenBalanceOfOperation extends AbstractTokenContractReadonlyOperation {

    private static final TokenContractActionType ACTION_TYPE = GET_BALANCE_OF;
