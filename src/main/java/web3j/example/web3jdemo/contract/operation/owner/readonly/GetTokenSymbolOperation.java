...
import static web3j.example.web3jdemo.contract.operation.actiontype.ContractOwnerActionType.GET_SYMBOL;

@Component
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class GetTokenSymbolOperation extends AbstractTokenContractReadonlyOperation {

    private static final ContractOwnerActionType ACTION_TYPE = GET_SYMBOL;
