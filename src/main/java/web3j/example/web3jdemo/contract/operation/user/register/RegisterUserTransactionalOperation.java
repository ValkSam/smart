...
public class RegisterUserTransactionalOperation extends AbstractContractUserRegisterTransactionalOperation {

    private static final ContractUserActionType ACTION_TYPE = REGISTER_USER;

    public RegisterUserTransactionalOperation(DldWallet dldWallet,
                                              String data) {
