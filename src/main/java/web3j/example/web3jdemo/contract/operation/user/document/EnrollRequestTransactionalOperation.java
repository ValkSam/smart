...
public class EnrollRequestTransactionalOperation extends AbstractContractUserDocumentTransactionalOperation {

    private static final ContractUserActionType ACTION_TYPE = ENROLL_REQUEST;

    public EnrollRequestTransactionalOperation(DldWallet dldWallet,
                                               BigInteger amount,
                                               String documentUid,
                                               String data) {
