...
public abstract class AbstractContractUserRegisterTransactionalOperation extends AbstractContractUserTransactionalOperation {

    private Consumer<RegisterEvent> onSuccess;
    private Consumer<RegisterUserReceipt> onReject;

    public AbstractContractUserRegisterTransactionalOperation(ContractUserActionType contractUserActionType,
                                                              DldWallet dldWallet,
                                                              String data,
