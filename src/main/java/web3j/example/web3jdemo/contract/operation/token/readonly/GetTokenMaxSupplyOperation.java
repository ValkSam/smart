...
import static web3j.example.web3jdemo.contract.operation.actiontype.TokenContractActionType.GET_MAX_SUPPLY;

@Component
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class GetTokenMaxSupplyOperation extends AbstractTokenContractReadonlyOperation {

    private static final TokenContractActionType ACTION_TYPE = GET_MAX_SUPPLY;
