...
import static web3j.example.web3jdemo.contract.operation.ContractOperation.ContractActionType.ENROLL_REQUEST;
import static web3j.example.web3jdemo.domain.UserAddressType.INDEX;

@Component
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class EnrollRequestTransferOperation extends ContractUserTransferOperation {

    private static final ContractActionType ACTION_TYPE = ENROLL_REQUEST;

    public EnrollRequestTransferOperation(DldWallet dldWallet,
                                          BigInteger amount,
                                          String documentUid,
                                          String data) {
