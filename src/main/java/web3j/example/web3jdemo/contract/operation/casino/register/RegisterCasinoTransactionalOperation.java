...
public class RegisterCasinoTransactionalOperation extends AbstractContractCasinoRegisterTransactionalOperation {

    private static final ContractCasinoActionType ACTION_TYPE = REGISTER_CASINO;

    public RegisterCasinoTransactionalOperation(Casino casino,
                                                String data) {
