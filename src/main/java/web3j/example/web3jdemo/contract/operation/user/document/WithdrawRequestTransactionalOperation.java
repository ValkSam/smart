...
public class WithdrawRequestTransactionalOperation extends AbstractContractUserDocumentTransactionalOperation {

    //TODO try to bind ACTION_TYPE with *EventResponse
    private static final ContractUserActionType ACTION_TYPE = WITHDRAW_REQUEST;

    public WithdrawRequestTransactionalOperation(DldWallet dldWallet,
                                                 BigInteger amount,
                                                 String documentUid,
                                                 String data) {
